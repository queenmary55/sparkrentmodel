...
config = {
    ...
    'null_processing_delete': ['area','price','custom_id'],
    ...
    # keys是原始值
    'uniformity_pay_type': {None:"其他","Null":"其他","押三付六": "押三付半年","(押一付三 )":"押一付三","可支持分期月付":"其他","押零付十二":"押零付年","付五":"押一付四","押0付11":"押零付十一",
    ...
    'uniformity_decoration': {None:0,"Null":0,"豪": 6, "豪装": 6, "简": 3, "简装": 3, "精": 5, "精装": 5, "毛坯": 1, "普": 2, "普装": 2, "未知": 0, "中": 4, "中装": 4},
    'uniformity_direction': {None:"其他","Null":"其他","北": "北", "西": "西", "朝西南": "西南", "朝北": "北", "朝西": "西", "西南": "西南", "朝东南": "东南", "南北": "南北", "朝西北": "西北", "东南": "东南",
