...
def dataUniform(df):
    ...
    for column in uniformity_fields:
        ...
        if column in cols:
            ...
            print('df.filter(df[colums].isNull()).count()=======data_uniformity_before', column,df.filter(df[column].isNull()).count())
            ...
            print('df.filter(df[colums].isNull()).count()=======data_uniformity_after', column,df.filter(df[column].isNull()).count())
